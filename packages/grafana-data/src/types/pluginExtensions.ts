...
export type PluginExtensionHook<Signature = () => void> = PluginExtensionBase & {
  type: PluginExtensionTypes.hook;
  title: string;
  hook: Signature;
};

export type PluginExtension = PluginExtensionLink | PluginExtensionComponent | PluginExtensionHook;
